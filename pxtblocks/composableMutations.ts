...
export function initExpandableBlock(info: pxtc.BlocksInfo, b: Blockly.Block, def: pxtc.ParsedBlockDef, comp: pxt.blocks.BlockCompileInfo, toggle: boolean, addInputs: () => void) {
    ...
    function addButton(name: string, uri: string, alt: string, delta: number) {
        ...
        .appendField(new FieldImageNoText(uri, 24, 24, undefined, () => updateShape(delta), false, {type: "field_mutator", ariaTypeName: 'mutator', alt}));
    }
    ...
    function addPlusAndMinusButtons() {
        b.appendDummyInput(buttonAddRemName)
            .appendField(new FieldImageNoText((b as any).REMOVE_IMAGE_DATAURI, 24, 24, undefined, () => updateShape(-1 * buttonDelta), false, {type: "field_mutator", ariaTypeName: 'mutator', alt: lf("Hide optional arguments")}))
            .appendField(new FieldImageNoText((b as any).ADD_IMAGE_DATAURI, 24, 24, undefined, () => updateShape(buttonDelta), false, {type: "field_mutator", ariaTypeName: 'mutator', alt: lf("Reveal optional arguments")}))
    }
